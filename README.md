...
```mermaid
flowchart TD
    A["用户输入<br/>帮我制作 AI 热点短视频文案"] --> B["aihot<br/>获取 AI HOT 热点"]
    B --> C["热点素材池<br/>标题 / 来源 / 链接 / 摘要 / 发布时间"]
    C --> D["aihot-video-copy-skill<br/>短视频文案编排"]

    D --> E["选题筛选<br/>短视频价值 / 事实来源 / 画面可表达"]
    E --> F["角度设计<br/>目标观众 / 观看悬念 / 内容承诺"]
    F --> G["口播生成<br/>70-85 秒数字人口播"]
    G --> H["字幕切分<br/>一句一行，方便剪辑"]
    H --> I["包装生成<br/>标题 / 5 秒 Hook / AI 画面方向"]
    I --> J["质量检查<br/>事实 / 节奏 / AI 写作特征"]
    J --> K["最终输出<br/>可发布短视频文案包"]

    D -. "可选" .-> L["账号方向定制<br/>科普 / 资讯 / 轻教程 / 商业解读"]
    L --> E
```
